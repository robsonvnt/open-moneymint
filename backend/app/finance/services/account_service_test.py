...
def test_create_account(account_service, mock_account_repo):
    ...
    result = account_service.create_account(mock_data)
...
def test_get_all_accounts_by_user_code(account_service, mock_account_repo):
    ...
    results = account_service.get_all_accounts_by_user_code("USER123")
...
def test_update_account(account_service, mock_account_repo):
    ...
    result = account_service.update_account("USER123", "ACC123", account)
...
def test_delete_account(account_service, mock_account_repo):
    ...
    result = account_service.delete_account("USER123", "ACC123")
