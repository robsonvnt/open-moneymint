...
interface AccountTransactionDialogFormProps {
    transaction: InputAccountTransaction;
    setTransaction: React.Dispatch<React.SetStateAction<InputAccountTransaction>>;
    open: boolean;
    onClose: () => void;
    onSave: (transaction: InputAccountTransaction) => void;
}
...
const AccountTransactionDialogForm: React.FC<AccountTransactionDialogFormProps> =
    ({
